...
This repository is for building base image containing base xfce install, this image can be used to make a uBlue image with xfce as the desktop enviroment.
